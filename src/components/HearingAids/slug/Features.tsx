      ...
      <div className="mt-6 border-t border-gray-100">
        <dl className="divide-y divide-gray-100">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <dd className="mt-1 text-sm leading-4 text-red-700 sm:col-span-2 sm:mt-0">
              <a className="text-base text-primary font-bold hover:underline cursor-pointer">{formatPrice(parseFloat(price))} BDT</a>
            </dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm font-medium leading-4 text-gray-900">
