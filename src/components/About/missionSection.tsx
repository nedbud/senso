...
const missions = [
    ...
    {
        description: 'Tailoring solutions to individual needs for effective hearing outcomes.'
    },
    {
        description: 'Embracing innovation for superior hearing aids and accessories.w'
    },
    {
        description: 'Providing understanding and guidance throughout the hearing journey.'
    },
    {
        description: 'Ensuring hearing care is accessible and affordable to all.'
    },
    {
        description: 'Fostering trusting relationships through transparency and integrity.'
    },
    {
        description: 'Advocating for hearing health awareness and community support'
    },
    {
        description: 'Improving quality of life through improved hearing experiences.'
    }
];
