...
export const metadata: Metadata = {
  applicationName: 'Senso Hearing Centre || Best Hearing centre in Dhaka, Bangladesh',
  referrer: 'origin-when-cross-origin',
  authors: [{ name: 'Senso Hearing Centre', url: 'https://sensohearingdhaka.com/' }],
  ...
  description: 'Senso hearing centre is the best hearing centre in Bangladesh. Senso Hearing Centre, Dhaka is one of the largest and reputed Hearing centre in Bangladesh. We pride our self at this side for 15 years. We assure your best hearing healthcare. We offer good price range of hearing aids in Bangladesh.',
  keywords: [
    'hearing',
    'aids aid',
    'aids hearing',
  ...
  openGraph: {
    ...
    siteName: 'Senso Hearing Centre || Best Hearing centre in Dhaka, Bangladesh',
    images: [
      {
